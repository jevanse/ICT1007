...
int main(void) {
	...
	// Variable delclaration
  	...
  	int i, j, n, et_buffer, loop,tat[10], TQ, ct[10], max_process_time, response_times[10], max_arrival_time, size_t, lmao_buffer, total_burst_time; int next_exe_time_start=0, total_arr_time, time_added; float total_waiting_time=0, total_turnaround_time=0;
